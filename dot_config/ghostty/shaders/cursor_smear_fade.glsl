...
// Source: KroneCorylus/ghostty-shader-playground (MIT)
// Modified: trail color uses Catppuccin Mocha cursor color
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Trail color: use the terminal cursor color from Ghostty
    vec4 TRAIL_COLOR = vec4(iCursorColor, 1.0);
